...
TEST(Knapsack, Empty) {
  EXPECT_EQ(SolveKnapsack({}, {}, 0, 0), KnapsackSolution({}, 0, 0, true));

  EXPECT_EQ(SolveKnapsack({}, {}, -1, 0), KnapsackSolution({}, 0, 0, false));

  EXPECT_EQ(SolveKnapsack({}, {}, 1, 0), KnapsackSolution({}, 0, 1, true));

  EXPECT_EQ(SolveKnapsack({}, {}, 0, -1), KnapsackSolution({}, 0, 0, true));

  EXPECT_EQ(SolveKnapsack({}, {}, 1, -1), KnapsackSolution({}, 0, 1, true));
...
TEST(Knapsack, TrivialOnWeight) {
  ...
  const auto result = SolveKnapsack(values, weights, -2, 0);
...
TEST(Knapsack, TrivialOnValue) {
  ...
  const auto result = SolveKnapsack(values, weights, -1, 2);
  EXPECT_TRUE(result.feasible);
