...
/* natural logarithm computed for 8 simultaneous float
   return NaN for x <= 0
*/
static __attribute__((__unused__)) v8sf log256_ps(v8sf x) {
  v8si imm0;
...
static __attribute__((__unused__)) v8sf exp256_ps(v8sf x) {
...
*/
static __attribute__((__unused__)) v8sf sin256_ps(v8sf x) {  // any x
...
static __attribute__((__unused__)) v8sf cos256_ps(v8sf x) {  // any x
...
static __attribute__((__unused__)) void sincos256_ps(v8sf x, v8sf *s, v8sf *c) {
